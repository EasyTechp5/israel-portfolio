...
const tools = [
  { name: "n8n", cat: "Automation", color: "bg-blue-500/10 text-blue-300 border-blue-500/20" },
  { name: "Make.com", cat: "Automation", color: "bg-blue-500/10 text-blue-300 border-blue-500/20" },
  ...
  { name: "Google Apps Script", cat: "Automation", color: "bg-blue-500/10 text-blue-300 border-blue-500/20" },
  ...
  { name: "Zapier", cat: "Automation", color: "bg-blue-500/10 text-blue-300 border-blue-500/20" },
...
export default function AboutPage() {
  return (
    <>
      {/* Hero */}
      <section className="relative min-h-[60vh] flex items-center overflow-hidden bg-gradient-to-br from-slate-950 via-blue-950/20 to-slate-950">
      ...
      <section className="section-padding">
        <div className="container-wide">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-400 max-w-xl mx-auto">The exact tools that power every automation, AI agent, and workflow Israel builds.</p>
          </div>
        ...
        <div className="container-wide max-w-4xl">
          <div className="text-center">
            ...
            <div className="relative glass-card p-10 rounded-3xl">
              ...
              <p className="text-slate-400 text-lg">Goal: Train 1 million people in AI and automation.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding relative overflow-hidden">
        ...
        <div className="container-wide relative z-10 text-center">
          ...
          <p className="text-slate-300 text-lg mb-8 max-w-xl mx-auto">Ready to automate your business or level up your AI skills? Let&apos;s talk.</p>

...
const colorMap: Record<string, { card: string; icon: string; tag: string }> = {
  blue: { card: "hover:border-blue-500/40", icon: "bg-[#0055DA]/20 border-[#0055DA]/30 text-muted", tag: "bg-[#0055DA]/20 text-muted border-[#0055DA]/30" },
    ...
    <>
            ...
            {filtered.map((p) => {
              ...
              return (
                <div key={p.title} className={`glass-card p-6 border transition-all duration-300 hover:-translate-y-1 group ${c.card}`}>
                  ...
                  <p className="text-subtle text-sm leading-relaxed mb-4">{p.desc}</p>
      ...
      <section className="section-padding relative overflow-hidden">
        ...
        <div className="container-wide relative z-10 text-center">
          ...
          <p className="text-muted text-lg mb-8 max-w-xl mx-auto">Let&apos;s talk about what&apos;s possible. Book a free 20-minute discovery call.</p>

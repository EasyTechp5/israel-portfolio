    ...
    <>
      ...
      <section className="section-padding bg-white/[0.02]">
        <div className="container-wide">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-xl mx-auto">Simple, transparent, and built around your outcome.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {process.map((p, i) => (
              <div key={p.step} className="relative glass-card p-6">
                ...
                <div className="w-10 h-10 rounded-xl bg-blue-600 flex items-center justify-center font-black text-sm text-white mb-4">
                  {p.step}
                </div>
      ...
      <section className="section-padding relative overflow-hidden">
        ...
        <div className="container-wide relative z-10 text-center">
          ...
          <p className="text-slate-300 text-lg mb-8 max-w-xl mx-auto">Book a free 20-minute call and I&apos;ll tell you exactly what would work best for your situation.</p>

    ...
    <footer className="bg-slate-900 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4 group">
              ...
              <span className="font-black text-lg text-white">
                Israel<span className="text-blue-400"> Afolabi</span>
              </span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3 mb-5">
              <li>
                <a href="mailto:afolabiisraelolajide@gmail.com" className="flex items-center gap-2 text-slate-400 hover:text-white text-sm transition-colors">
                  <Mail className="w-4 h-4 flex-shrink-0" />
                  afolabiisraelolajide@gmail.com
                </a>
              </li>
              <li>
                <a href="https://wa.me/2348139464398" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-slate-400 hover:text-white text-sm transition-colors">
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-slate-500 text-sm">© {new Date().getFullYear()} Israel Afolabi. All rights reserved.</p>

    ...
    <footer className="bg-[#080f1e] border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4 group">
              <div className="w-9 h-9 rounded-xl bg-[#0055DA] flex items-center justify-center shadow-lg">
                <Bot className="w-5 h-5 text-white" />
              </div>
              <span className="font-black text-lg text-white">
                Israel<span className="text-[#6aabff]"> Afolabi</span>
              </span>
            </Link>
            <p className="text-[#7799cc] text-sm leading-relaxed mb-5">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {navLinks.map((l) => (
                <li key={l.href}>
                  <Link href={l.href} className="text-[#7799cc] hover:text-white text-sm transition-colors">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2">
              {services.map((s) => (
                <li key={s}>
                  <Link href="/services" className="text-[#7799cc] hover:text-white text-sm transition-colors">
                    {s}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3 mb-5">
              <li>
                <a href="mailto:afolabiisraelolajide@gmail.com" className="flex items-center gap-2 text-[#7799cc] hover:text-white text-sm transition-colors">
                  <Mail className="w-4 h-4 flex-shrink-0" />
                  afolabiisraelolajide@gmail.com
                </a>
              </li>
              <li>
                <a href="https://wa.me/2348139464398" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[#7799cc] hover:text-white text-sm transition-colors">
                  <Phone className="w-4 h-4 flex-shrink-0" />
                  +2348139464398
                </a>
              </li>
              <li className="flex items-center gap-2 text-[#7799cc] text-sm">
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-[#5566aa] text-sm">© {new Date().getFullYear()} Israel Afolabi. All rights reserved.</p>
          <div className="flex items-center gap-4 text-[#5566aa] text-sm">
